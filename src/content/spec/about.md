...
我是 **伏枥**。这个笔名取自「老骥伏枥，志在千里」，也是我本名的化用。
...
进一步有进一步的欢喜，永远相信美好的事情即将发生。

## 📖 这里写些什么

### 0x0｜[Debug2Deploy · 推理到跑通](https://leehenry.top/archive/?category=推理到跑通)

> 计算机科学，我理解世界的另一种方式 · *CS, a new path to making sense of the world.*

记录下我在 0 与 1 之间的旅程。每一次搞懂、调试、优化与实现，都是我试着撬开黑箱、回应复杂世界的笨拙尝试。

### 0x1｜[Moment Memos · 瞬间备忘录](https://leehenry.top/archive/?category=瞬间备忘录)

> 用镜头和片语留住稍纵即逝的念头 · *To catch the fleeting beauty of the everyday.*

生活里那些画面与感受的决定性瞬间，总是不期而遇。这些瞬间看似琐碎，却是足以串联起我生活的感知线索。

### 0x2｜[Mindlight Maze · 话从哪说起](https://leehenry.top/archive/?category=话从哪说起)

> 一念起，思绪在光影中生长 · *Where thoughts wander, words begin.*
...
> 拆解方法，记录路径，让行动变得清晰 · *Hacked, tracked, to shared.*
...
受好奇心与求知欲驱使，我在摸索中学习。我将在这里留下脚印，告诉你「我是怎么逐渐懂一点点的」。审美到认知，一切成长都值得慢慢来。
...
- `2023-07-06`  [「LH's Blog」](https://leehero0803.github.io/) 上线（本站前身），基于 [Hexo](https://hexo.io/zh-cn/) 框架与 [Keep 主题](https://keep-docs.xpoet.cn/) 于 [GitHub Page](https://github.com/LeeHero0803/LeeHero0803.github.io) 完成部署。
- `2025-08-20` [「伏枥之间」](https://www.leehenry.top)上线，基于 [Astro](https://astro.build/) 框架与 [Fuwari](https://github.com/saicaca/fuwari) 主题于 [阿里云](https://www.aliyun.com/) 完成部署。
- `2025-08-25` 域名 [leehenry.top](https://www.leehenry.top) 完成备案，接入本站。
- `2025-09-12` 「伏枥之间」完成所有历史博文迁移同步工作。

- `2025-09-13` 「伏枥之间」上线 [RSS](https://leehenry.top/rss.xml) 订阅。
