...
- `2023-07-06` 前身站点 [LH's Blog](https://leehero0803.github.io/) 基于 [Hexo](https://hexo.io/zh-cn/) 框架与 [Keep 主题](https://keep-docs.xpoet.cn/) 于 [GitHub Page](https://github.com/LeeHero0803/LeeHero0803.github.io)完成部署。
- `2025-08-20` 正式上线「伏枥之间」，基于 [Astro](https://astro.build/) 框架与 [Fuwari](https://github.com/saicaca/fuwari) 主题于[阿里云](https://www.aliyun.com/)完成部署。
- `2025-08-25` 域名 [leehenry.top](leehenry.top) 完成备案，接入本站。
